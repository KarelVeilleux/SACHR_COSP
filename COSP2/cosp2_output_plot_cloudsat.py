...
cosp_dbze_cslevel = format_levels(cosp_dbze, overlap_coeff)
...
figure_name = figure_directory + '/profil/radar_reflectivity_'  + strdate + '_cloudsat_W'
plt.savefig(figure_name,dpi=150,bbox_inches='tight')
print(figure_name)


plt.figure(2)
data = gem_zet_cslevel
fig = plt.imshow(data,cmap)
fig.set_clim(vmin=clim[0], vmax=clim[1]);
axes=plt.gca()
#axes.invert_yaxis()
...
plt.title('GEM: total equivalent reflectivity [ZET]')
plt.ylabel('Altitude [km]')
#plt.yticks(ytick_cs,ylabel)
plt.yticks(ytick_gem,ylabel)
plt.ylim([ytick_gem[0],ytick_gem[-1]])
figure_name = figure_directory + '/profil/radar_reflectivity_'  + strdate  + '_gem_W'
plt.savefig(figure_name,dpi=150,bbox_inches='tight')
plt.show(block=False)
print(figure_name)
...
plt.plot(orography_x,orography_y,'k-',linewidth=0.5)
plt.fill(orography_x,orography_y,'w')
plt.title('GEM + COSP2: CloudSat radar reflectivity [dbze94]')
plt.ylabel('Altitude [km]')
plt.yticks(ytick_gem,ylabel)
plt.ylim([ytick_gem[0],ytick_gem[-1]])
figure_name = figure_directory + '/profil/radar_reflectivity_'  + strdate  + '_cosp_W'
plt.savefig(figure_name,dpi=150,bbox_inches='tight')
plt.show(block=False)
print(figure_name)
