...
for i in range(i):
    ...
    ncfile_gem      ='/pampa/poitras/DATA/GEM5/COSP2/' + gempath + '/Samples_NetCDF/COSP2_NAM-11m_ERA5_GEM5_CLASS_NEWVEG_newP3-SCPF_SN_Lakes_201409/pm2013010100_20140901d.nc'
...
PROFIL_gemX    ['total_cloud_cover'] = PROFIL_gemX    ['total_cloud_cover'] >0.1
PROFIL_cospoutX    ['total_cloud_cover'] = PROFIL_cospoutX    ['total_cloud_cover'] >0
PROFIL_calipsoX    ['total_cloud_cover'] = PROFIL_calipsoX    ['total_cloud_cover'] >0

PROFIL_gemX        ['orography'        ]= PROFIL_calipsoX['orography'        ]
PROFIL_cospoutX    ['orography'        ]= PROFIL_calipsoX['orography'        ]
