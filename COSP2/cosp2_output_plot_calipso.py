...
varlist_cospout = [ 'atb532','atb532_perp']
...
cosp_ATB532    = data_cosp['atb532'   ]
cosp_atb532    = np.zeros((71,Nray))
...
for n in range(Nray):
    ...
    cosp_atb532   [:,    n] = cosp_ATB532   [:, I_cosp  , J_cosp  ]
...
overlap_coeff = compute_overlap_coeff(cosp_layer, np.flip(target_layer))
...
cosp_atb532_cslevel = format_levels(cosp_atb532, overlap_coeff)
